import { boothAdjustApplyApi } from '../../../apis';
  ...
  actions: {
    ...
    getNumberBoothData({ commit }, obj) {
      return new Promise((resolve, reject) => {
        boothAdjustApplyApi.numberBoothData(obj).then(res => {
    ...
    postNewlyAddedBooths({ commit }, obj) {
      return new Promise((resolve, reject) => {
        boothAdjustApplyApi.newlyAddedBooths(obj).then(res => {
    ...
    postNewModification({ commit }, obj) {
      return new Promise((resolve, reject) => {
        boothAdjustApplyApi.newlyAddedSubmitted(obj).then(res => {
    ...
    postDeleteAddedBooths({ commit }, obj) {
      return new Promise((resolve, reject) => {
        boothAdjustApplyApi.deleteAddedBooths(obj).then(res => {
    ...
    postRecommended({ commit }, obj) {
      return new Promise((resolve, reject) => {
        boothAdjustApplyApi.originalRecommended(obj).then(res => {
