import { boxNumberListApi } from "../../../apis";
export default {
  namespaced: true,
  state: {
    addRecordData: {},
  ...
  actions: {
    ...
    getRecords({ commit }, Object) {
      return new Promise((resolve, reject) => {
        boxNumberListApi.getRecordsData(Object).then(res => {
    ...
    addRecord({ commit }, Object) {
      return new Promise((resolve, reject) => {
        boxNumberListApi.addRecordData(Object).then(res => {
    ...
    removeRecord({ commit }, Object) {
      return new Promise((resolve, reject) => {
        boxNumberListApi.removeRecordData(Object).then(res => {
    ...
    updateRecord({ commit }, Object) {
      return new Promise((resolve, reject) => {
        boxNumberListApi.updateRecordData(Object).then(res => {
    ...
    getLoginInfo({ commit }, Object) {
      return new Promise((resolve, reject) => {
        boxNumberListApi.getLoginInfoData(Object).then(res => {
