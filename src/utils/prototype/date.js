...
Date.prototype.formatDate = function(formatStr) {
  let newformatStr = formatStr;
  if (kindo.validate.isEmpty(newformatStr)) {
    newformatStr = 'yyyy-MM-dd';
  }
  ...
  return newformatStr.replace(/(yyyy|MM?|dd?|HH?|ss?|mm?)/g, function() {
...
Date.prototype.formatTime = function(formatStr) {
  let newformatStr = formatStr;
  if (kindo.validate.isEmpty(newformatStr)) {
    newformatStr = 'yyyy-MM-dd HH:mm:ss';
  }

  return this.formatDate(newformatStr);
};
