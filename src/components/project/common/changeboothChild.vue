  ...
  <div>
    <el-row>
      <el-col :span="8" style="text-align:left">
        <div>
          <el-select v-model="inputForm.exAreaId" style="width:80%" placeholder="展区"
      ...
      <el-col :span="8" style="text-align:center;padding:0 5px">
        <div>
          <el-select v-model="inputForm.fstCatalogId" style="width:80%" placeholder="一级目录"
      ...
      <el-col :span="8" style="text-align:right">
        <div>
          <el-select v-model="inputForm.secCatalogId" style="width:80%" placeholder="二级目录"
            @change="revealForm">
...
export default {
  ...
  methods: {
    ...mapActions('commonStore', ['getBooth', 'getBoothChild']),
    //新增中展区1、2级菜单的变化
