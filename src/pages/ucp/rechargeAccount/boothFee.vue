<template>
  <el-page ref="boothFee">
    ...
    <template slot="header">
      <kindo-box :title="languageSource.CommonPayLang.boothFeeRegistration" icon="fa-search">
      </kindo-box>
            ...
            <el-row>
              ...
              <el-col :span="11">
                ...
                <el-form-item label-width="25%">
                  <el-button type="primary" v-if="right('boothFeeSave')" @click="onSave()" icon="glyphicon glyphicon-floppy-disk">{{languageSource.CommonLang.save}}</el-button>
                  <el-button icon="el-icon-close" v-if="right('boothFeeCancel')" @click="onCancel()">{{languageSource.CommonLang.cancel}}</el-button>
                </el-form-item>
              </el-col>
            </el-row>
          </el-form>
