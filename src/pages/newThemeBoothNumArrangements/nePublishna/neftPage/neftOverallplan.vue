  ...
  <div v-loading.fullscreen="fullLoading">
    <el-card style="padding-bottom: 24px">
      ...
      <div class="paginationTop floatLeft">
        <el-button type="danger" size="small" class="formStyle" @click="addExhibition">公布</el-button>
    ...
    submitPublish(fname) {
      this.$refs[fname].validate((valid) => {
        if (valid) {
          ...
          this.getpublishNewthemePublish(publishparm)
          .then(res => {
            let parmdat = [];
            ...
            this.addpublishNewthemePublish(parmdat).then(resa => {
