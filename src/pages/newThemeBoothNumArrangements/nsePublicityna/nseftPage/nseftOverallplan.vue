  ...
  <div v-loading.fullscreen="fullLoading">
    <el-card style="padding-bottom: 24px">
      ...
      <div class="paginationTop floatLeft">
        <el-button type="danger" class="formStyle" size="small" @click="addExhibition">公示</el-button>
      ...
      <!-- 公示/公布 close-on-click-modal="false" 弹框遮罩层点击不关闭 -->
      <el-dialog title="公示" :visible.sync="isExhibit" :close-on-click-modal="false" v-if="isExhibit" width="400px">
        <el-form :model="publishedForm" ref="publishedForm" :rules="publishRules" label-width="150px">
...
export default {
  ...
  created() {
    ...
    // console.log(this.usInfo, "userinfo");
    ...
    submitPublish(fname) {
      this.$refs[fname].validate((valid) => {
        if (valid) {
          ...
          this.getpublicityThemePublish(publishparm)
          .then(res => {
            let parmdat = [];
            ...
            this.addnewthemePublish(parmdat).then(resa => {
