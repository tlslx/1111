...
export default {
  ...
  methods: {
    ...
    // 下载
    handDownload() {
      let url = `${this.paginationData.currentPage}&size=${this.paginationData.total}&exhibitionArea=${this.formData.exhibitionArea}&delegationId=${this.formData.delegationId}&coceralId=${this.obj.coceralId}&exhibitionType=${this.formData.exhibitionType}&productType=${this.formData.productType}&companyName=${this.formData.companyName}&token=${this.token}`;
