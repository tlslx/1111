<template>
  <el-page ref="sysUnifyUser">
    ...
    <template slot="body" slot-scope="scope">
      <!--数据区域-->
      <el-page-data>
        <el-datagrid ref="datagrid" :height="scope.height-8" :query-params="queryParams" row-key="userId"
          data-url="/api/sysUnifyUser/getListPage" delete-url="/api/sysUnifyUser/deleteBatchIds">
          ...
          <el-table-column prop="account" label="" width="100" sortable="custom"></el-table-column>
          ...
          <el-table-column prop="email" label="" width="100" sortable="custom"></el-table-column>
          <el-table-column prop="mobile" label="" width="100" sortable="custom"></el-table-column>
          ...
          <el-table-column prop="password" label="" width="100" sortable="custom"></el-table-column>
          <el-table-column prop="qq" label="" width="100" sortable="custom"></el-table-column>
          <el-table-column prop="remark" label="" width="100" sortable="custom"></el-table-column>
          <el-table-column prop="source" label="1=OA/2=外部" width="100" sortable="custom"></el-table-column>
          ...
          <el-table-column prop="userName" label="" width="100" sortable="custom"></el-table-column>
          <el-table-column prop="weixin" label="" width="100" sortable="custom"></el-table-column>
        </el-datagrid>
      </el-page-data>
    </template>
  </el-page>
...
<script>
import editPage from '@/pages/manager/sysUnifyUserEdit';
