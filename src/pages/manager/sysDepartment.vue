    ...
    <template slot="body" slot-scope="scope">
      ...
      <el-page-data>
        <el-treegrid ref="datagrid" :height="scope.height-8" 
          ...
          <!-- <el-table-column prop="deptName" label="部门名称" width="200" sortable="custom"></el-table-column> -->
          <el-table-column prop="fullName" label="部门全名" width="200" sortable="custom"></el-table-column>
          <!-- <el-table-column prop="parentName" label="上级部门" width="200" sortable="custom"></el-table-column> -->
          <!-- <el-table-column prop="parentCode" label="上级部门编码" width="150" sortable="custom"></el-table-column> -->
          <el-table-column prop="deptLevel" label="部门层级" width="100" sortable="custom" :formatter="dataDict"></el-table-column>
          <el-table-column prop="deptType" label="机构类型" width="100" sortable="custom" :formatter="dataDict"></el-table-column>
          ...
          <!-- <el-table-column prop="isOa" label="是否OA部门" width="120" sortable="custom"></el-table-column> -->
          <!-- <el-table-column prop="levelCode" label="层级编码" width="120" sortable="custom"></el-table-column> -->
...
<script>
import editPage from "@/pages/manager/sysDepartmentEdit";
