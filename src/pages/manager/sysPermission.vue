<template>
  <el-page ref="sysPermission">
    ...
    <template slot="body" slot-scope="scope">
      <!--数据区域-->
      <el-page-data>
        <el-datagrid ref="datagrid" :height="scope.height-8" :query-params="queryParams" row-key="permissionId"
          data-url="/api/sysPermission/getListPage" delete-url="/api/sysPermission/deleteBatchIds">
          ...
          <el-table-column prop="menuId" label="SYS_MENU/MENU_ID" width="100" sortable="custom"></el-table-column>
          ...
          <el-table-column prop="operId" label="SYS_OPERATION/OPER_ID" width="100" sortable="custom"></el-table-column>
          <el-table-column prop="orderNo" label="" width="100" sortable="custom"></el-table-column>
          <el-table-column prop="permissionCode" label="" width="100" sortable="custom"></el-table-column>
          <el-table-column prop="permissionId" label="" width="100" sortable="custom"></el-table-column>
...
<script>
import editPage from '@/pages/manager/sysPermissionEdit';
