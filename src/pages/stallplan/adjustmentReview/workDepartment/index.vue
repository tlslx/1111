<template>
  <el-page class="seat">
    <template slot="body">
      <el-header>
        <headline label="工作部审核结果汇总"></headline>
      </el-header>
      <kindo-box>
        <el-form :inline="true" size="small" :model="searchForm" ref="searchForm" label-width="100px"
          ...
          <el-form-item prop="exhibitionAreaName" label="展区：">
      ...
      <kindo-box>
        ...
        >
        <el-table-column prop="exhibitionAreaName" label="交易团" min-width="160" header-align="center" align="center"></el-table-column>
          <el-table-column prop="exhibitionProperty" label="展区" min-width="160" header-align="center" align="center"></el-table-column>
          <el-table-column prop="schemeName" label="广交会编码" min-width="200" header-align="center" align="center"></el-table-column>
          ...
          <el-table-column prop="modifierName" label="调整类型" min-width="160" header-align="center" align="center"></el-table-column>
          ...
          <!-- <el-table-column prop="exhibitionAreaName" label="展会" min-width="160" header-align="center" align="center"></el-table-column>
          <el-table-column prop="exhibitionProperty" label="届数" min-width="160" header-align="center" align="center"></el-table-column>
          <el-table-column prop="schemeName" label="展期" min-width="200" header-align="center" align="center"></el-table-column>
          <el-table-column prop="creatorName" label="展区名称" min-width="160" header-align="center" align="center"></el-table-column>
          <el-table-column prop="createDate" label="展位性质" min-width="160" header-align="center" align="center"></el-table-column>
          <el-table-column prop="modifierName" label="方案名称" min-width="160" header-align="center" align="center"></el-table-column>
          <el-table-column prop="modifyDate" label="方案安排单位" min-width="160" header-align="center" align="center"></el-table-column>
          <el-table-column prop="description" label="方案创建人" min-width="160" header-align="center" align="center"></el-table-column>
          <el-table-column prop="description" label="方案创建时间" min-width="160" header-align="center" align="center"></el-table-column>
          <el-table-column prop="description" label="方案修改人" min-width="160" header-align="center" align="center"></el-table-column>
          <el-table-column prop="description" label="方案修改时间" min-width="160" header-align="center" align="center"></el-table-column>
          <el-table-column prop="description" label="方案状态" min-width="160" header-align="center" align="center"></el-table-column>
          <el-table-column prop="description" label="待处理人" min-width="160" header-align="center" align="center"></el-table-column> -->
          <el-table-column prop="publicityStartDate" fixed="right" :label="languageSource.CommonLang.operation" min-width="130" header-align="center" align="center">
            <template slot-scope="scope" >
              <router-link :to="{ path: '/stallplan/reviewForm?primarycolor=2b579a', query: { scopeRow: scope.row, tag: 'workDepartment' }}"><el-button type="text" size="mini">审核</el-button></router-link>
            </template>
          </el-table-column>
        </kindo-table>
      </kindo-box>
...
export default {
  ...
  async created () {
    ...
    // this.languageSource.BaseMapLang = await kindo.util.getLanguage('BaseMapLang');
  },
  mounted() {
    // this.getActName();
