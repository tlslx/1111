<template>
  <el-container>
    ...
    <el-main v-loading.fullscreen.lock="fullscreenLoading">
      <el-form :inline="false" size="small" label-width="120px">
        <el-row>
          <el-col :span="7">
        ...
        <el-row>
          ...
          <el-col :span="2">
            <el-button type="primary" class="checkBtn" size="small" v-if="businessState === 0">{{languageSource.AdjustmentApply.verify}}</el-button>
            &nbsp;&nbsp;
          </el-col>
          <el-col :span="7">
      ...
      <el-row v-if='btnShowState'>
        <el-col :span="2" :offset="11">
          <div>
            <router-link :to="{ path: '/stallplan/workDepartment?primarycolor=2b579a'}">
              <el-button>{{languageSource.AdjustmentApply.backBtn}}</el-button>
            </router-link>
          </div>
        </el-col>
      </el-row>
...
export default {
  ...
  computed: {
    titleText: function () {
      if (this.$route.query && this.$route.query.tag && this.$route.query.tag === 'workDepartment') {
