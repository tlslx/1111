  ...
  <div class="warrant">
    ...
    <kindo-box>
      <kindo-table
        ...
        :queryParam="form"
      >
        <el-table-column prop="enterpriseName" :label="languageSource.RuleSettingLang.enterpriseName" header-align="center" align="center" min-width="228px"></el-table-column>
        <el-table-column prop="exhibitionType" :label="languageSource.RuleSettingLang.exhibitionPositionType" header-align="center" align="center" min-width="223px"></el-table-column>
        <el-table-column prop="exhibitionArea" :label="languageSource.LocationLang.exhibitionArea"  header-align="center" align="center" min-width="223px"></el-table-column>
        <el-table-column prop="authorizedContent" :label="languageSource.RuleSettingLang.authorizedContent" header-align="center" align="center" min-width="223px"></el-table-column>
        <el-table-column :label="languageSource.CommonLang.operation" header-align="center" align="center" min-width="110px">
          <template slot-scope="scope">
            <confirm-button message="是否移除该企业标摊调整范围授权？" button-type="text" @remove="handleRemove(scope.row.changeId)">移除</confirm-button>
          </template>
        </el-table-column>
      </kindo-table>
    </kindo-box>
...
export default {
  ...
  methods: {
    ...
    // 移除
    handleRemove (id) {
      this.$http.postJson(this.config.api.removeAuthorizedEnterprise, [id])
        .then(res => {
          this.$refs.table.loadData();
        });
    },
