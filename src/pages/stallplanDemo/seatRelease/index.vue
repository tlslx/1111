<template>
  <el-page class="seat">
    <template slot="header">
      <kindo-box :title="languageSource.AdjustmentApply.seatPublicityTitle">
...
export default {
  ...
  methods: {
    ...
    gotoPage (row) {
      this.$router.push({ path: '/stallplanDemo/seatArea?primarycolor=2b579a', query: { businessKey: row.schemeId, scopeRow: row, tag: 'seatPublicity', right: 'seatApplyView', pluginBtnState: false, addState: false, notValidateArray: [] }});
    }
  }
};
</script>
