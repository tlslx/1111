<template>
  <el-dialog
    :title="languageSource.RuleSettingLang.addAuthorized"
    ...
    <kindo-box>
      ...
      <el-form :inline="true" :model="searchForm" ref="searchForm" label-position="left" label-width="85px"
        ...
        <el-form-item prop="exhibitionArea" :label="languageSource.LocationLang.exhibitionAreaTable"  label-width="60px">
  ...
  methods: {
    ...
    confirm () {
      if (this.chooses.length) {
        ...
        this.$message.error(this.languageSource.RuleSettingLang.warrantDialogTips);
      }
    },
