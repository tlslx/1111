...
export default {
  api: {
    ...
    reviewArrangementStartApprove: `${host}/api/patchschema/startApprove`,
    //商协会位置安审核提交
    // reviewArrangementSubmitApprove: `${host}/api/applyScheme/submitApprove`,
    reviewArrangementSubmitApprove: `${host}/api/patchschema/submitApprove`,
    //商协会位置安排删除接口
    reviewArrangementDelete: `${host}/api/applyScheme/deleteSchema`,
    //商协会位置安排保存接口
    // reviewArrangementUpdateSchema: `${host}/api/applyScheme/updateSchema`,
    reviewArrangementUpdateSchema: `${host}/api/patchschema/updateSchema`,
    //商协会位置安排保存接口
    // reviewArrangementReSubmit: `${host}/api/applyScheme/reSubmitApprove`,
    reviewArrangementReSubmit: `${host}/api/patchschema/reSubmitApprove`,
    //工作部审核页面
    ...
    //商协会位置安排安排原因提交
    submitPatchScheme: `${host}/api/special/submitPatchScheme`,
    //商协会位置安排安排原因保存
    savePatchScheme: `${host}/api/special/savePatchScheme`,
    //根据选择集合查询企业调整信息
