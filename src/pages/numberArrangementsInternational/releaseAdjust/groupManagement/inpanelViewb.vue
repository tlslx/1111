<template>
  ...
  <div v-loading.fullscreen="fullLoading">
    ...
    <el-table :data="tableData" style="width: 100%" border size="small" :summary-method="getSummaries">
      ...
      <el-table-column align="center" min-width="76" label="实际安排特装数" prop="actualRecommendSpecial">
        <template slot-scope="scope">
          {{scope.row.actualRecommendSpecial == null ? "0" : scope.row.actualRecommendSpecial}}
        </template>
      </el-table-column>
      <el-table-column align="center" min-width="76" label="实际安排标摊数" prop="actualRecommendStandard">
        <template slot-scope="scope">
          {{scope.row.actualRecommendStandard == null ? "0" : scope.row.actualRecommendStandard}}
        </template>
      </el-table-column>
      <el-table-column align="center" min-width="90" label="实际安排卡车通道数" prop="actualRecommendCentralChannel">
        <template slot-scope="scope">
