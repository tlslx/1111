<template>
  <el-tabs v-model="activeName">
    <el-tab-pane label="收费函模板维护" name="first">
      <div class="queryBtn">
      ...
      <el-table border v-loading="loading">
        <el-table-column label="模板名称" align="center" prop="exhibitionSession"></el-table-column>
        <el-table-column label="审核状态" align="center" prop="exhibitionSession"></el-table-column>
      ...
      <el-dialog :title="diaTitle" :visible.sync="isSet" v-if="isSet">
        <el-form class="setForm" :model="addEditData" ref="setForm" :rules="setRule" label-width="160px">
          <el-form-item label="名称：" prop="exportUpperLimit">
            <el-input placeholder="请输入" v-model.trim.number="addEditData.exportUpperLimit" clearable></el-input>
          </el-form-item>
          <el-form-item label="模板内容：" prop="exportUpperLimit">
            <el-input placeholder="请输入" v-model.trim.number="addEditData.exportUpperLimit" clearable></el-input>
          </el-form-item>
        </el-form>
        <div class="dialog-footer">
          <el-button type="primary" size="medium" v-if="diaTitle === '新增'">确认</el-button>
          <el-button type="primary" size="medium" v-if="diaTitle === '编辑'">覆盖原模板</el-button>
          <el-button type="primary" size="medium" v-if="diaTitle === '编辑'">存储为新模板</el-button>
