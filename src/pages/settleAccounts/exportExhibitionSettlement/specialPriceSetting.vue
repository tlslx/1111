<template>
  <el-tabs v-model="activeName">
    <el-tab-pane label="特定展位价格设置" name="first">
      ...
      <el-table border v-loading="loading">
        ...
        <el-table-column label="展位类型" align="center" prop="exhibitionSession"></el-table-column>
        <el-table-column label="展位位置" align="center" prop="exhibitionSession"></el-table-column>
        <el-table-column label="特定展位价格" align="center" prop="exhibitionSession"></el-table-column>
        <el-table-column label="标准展位价格" align="center" prop="exhibitionSession"></el-table-column>
      ...
      <el-dialog :title="diaTitle" :visible.sync="isSet" v-if="isSet">
        <el-form class="setForm" :model="addEditData" ref="setForm" :rules="setRule" label-width="160px">
          ...
          <el-form-item label="展位号：" prop="exportUpperLimit">
            <el-input v-model.trim.number="addEditData.exportUpperLimit" readonly></el-input>
          </el-form-item>
          <el-form-item label="展位类型" prop="priority">
            <el-select v-model="addEditData.priority" clearable>
              <el-option v-for="(item, index) in exhibitionSessionOpts" :key="index" :value="item" :label="item"></el-option>
            </el-select>
          </el-form-item>
          <el-form-item label="展位位置：" prop="priority">
            <el-select v-model="addEditData.priority" clearable>
              <el-option v-for="(item, index) in exhibitionSessionOpts" :key="index" :value="item" :label="item"></el-option>
            </el-select>
          </el-form-item>
          <el-form-item label="特定展位价格：" prop="exportUpperLimit">
            <el-input placeholder="请输入" v-model.trim.number="addEditData.exportUpperLimit" clearable></el-input>
          </el-form-item>
          <el-form-item label="标准展位价格：" prop="exportUpperLimit">
            <el-input placeholder="请输入" v-model.trim.number="addEditData.exportUpperLimit" clearable></el-input>
          </el-form-item>
        </el-form>
