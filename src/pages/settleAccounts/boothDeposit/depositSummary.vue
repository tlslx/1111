<template>
  <el-tabs v-model="activeName">
    <el-tab-pane label="定金汇总" name="first">
      <el-tabs v-model="activeNameTwo" type="card" @tab-click="handleClick">
        <el-tab-pane label="设置定金比例" name="one">
        ...
        <el-tab-pane label="汇总计算定金" name="two">
          ...
          <div style="padding-top: 10px;float: right;">
            <pagination
              :pageInfo="paginationTwo"
              @handle-size-change="handleSizeChangeTwo"
              @handle-current-change="handleCurrentChangeTwo"
            ></pagination>
          </div>
        </el-tab-pane>
      </el-tabs>
