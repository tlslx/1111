...
<template>
  <el-tabs v-model="activeName">
    <el-tab-pane label="汇总展位预订款数据" name="first">
      <el-form :model="queryForm" :inline="true" size="small" label-width="80" class="boothForm">
        ...
        <el-form-item label="">
          <el-button type="primary">读取展位数量安排</el-button>
        </el-form-item>
        <!-- 横线 -->
      ...
      <div class="paginationTop floatLeft">
        <el-button type="primary" class="formStyle" size="small">汇总计算预订款</el-button>
      </div>
      <!-- 分页 -->
