...
<template>
  <el-tabs v-model="activeName">
    <el-tab-pane label="预收费明细" name="first">
      ...
      <div class="paginationTop floatLeft" style="margin-bottom: 20px;">
        <el-button type="primary" class="formStyle" size="small">打印</el-button>
        <el-button type="primary" class="formStyle" size="small">导出</el-button>
      </div>
      ...
      <!-- <simpleness-table
        ...
        @skip="skip"
      ></simpleness-table> -->
      <el-table :data="tableData" style="width: 100%" size="small" show-summary>
        <el-table-column min-width="90" align="center" prop="date" label="期数"></el-table-column>
        <el-table-column min-width="90" align="center" prop="name" label="交易团"></el-table-column>
        <el-table-column min-width="90" align="center" prop="address" label="企业"></el-table-column>
        <el-table-column min-width="90" align="center" prop="address" label="结算方式"></el-table-column>
        <el-table-column min-width="90" align="center" prop="address" label="展区"></el-table-column>
        <el-table-column min-width="90" align="center" prop="address" label="专区"></el-table-column>
        <el-table-column min-width="90" align="center" prop="address" label="展位位置"></el-table-column>
        <el-table-column min-width="90" align="center" prop="address" label="一般性展位">
          <el-table-column min-width="90" align="center" prop="address" label="标摊数量"></el-table-column>
          <el-table-column min-width="90" align="center" prop="address" label="特装数量"></el-table-column>
          <el-table-column min-width="90" align="center" prop="address" label="展位费"></el-table-column>
          <el-table-column min-width="90" align="center" prop="address" label="配置费"></el-table-column>
          <el-table-column min-width="90" align="center" prop="address" label="统一布展费"></el-table-column>
        </el-table-column>
        <el-table-column min-width="90" align="center" prop="address" label="品牌展位">
          <el-table-column min-width="90" align="center" prop="address" label="数量"></el-table-column>
          <el-table-column min-width="90" align="center" prop="address" label="展位费"></el-table-column>
          <el-table-column min-width="90" align="center" prop="address" label="统一布展费"></el-table-column>
        </el-table-column>
        <el-table-column min-width="90" align="center" prop="address" label="包期通讯费"></el-table-column>
        <el-table-column min-width="90" align="center" prop="address" label="展位数量合计"></el-table-column>
        <el-table-column min-width="90" align="center" prop="address" label="参展费用合计"></el-table-column>
        <el-table-column min-width="90" align="center" prop="address" label="实收展位数量合计"></el-table-column>
        <el-table-column min-width="90" align="center" prop="address" label="实收参展费用合计"></el-table-column>
      </el-table>
      <div class="paginationTop floatLeft">
        <el-button type="primary" class="formStyle" size="small">打印</el-button>
        <el-button type="primary" class="formStyle" size="small">返回</el-button>
      </div>
      <!-- 不通过弹框 -->
