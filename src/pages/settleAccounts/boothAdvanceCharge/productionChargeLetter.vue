...
<template>
  <el-tabs v-model="activeName">
    <el-tab-pane label="制作收费函" name="first">
        ...
        <div style="display: inline-block; line-height: 50px">
          <span>打印内容：</span>
           <el-checkbox-group v-model="checkList" style="display: inline-block;">
            ...
            <el-checkbox label="费用清单（专区）"></el-checkbox>
...
export default {
  ...
  methods: {
    ...
    preview(val) {
      this.$router.push({
        path: "/productionChargeLetterDetile",
        qurey: {
          data: val
        }
      });
