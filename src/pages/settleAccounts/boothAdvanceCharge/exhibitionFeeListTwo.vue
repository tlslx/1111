...
<template>
  <el-tabs v-model="activeName">
    <el-tab-pane label="第120届广交会参展费用清单（分区域）第二期" name="first">
      <div class="clearfloat">
        <div style="width: 50%; float: left;">
          <p><span>编码：010</span></p>
          <p><span>组团单位：北京</span></p>
        </div>
        <p style="line-height: 50px; float: right;">金额单位：元</p>
      </div>
      ...
      <el-table :data="tableData" style="width: 100%" size="small" show-summary>
        ...
        <el-table-column min-width="90" align="center" prop="address" label="一般性展位">
          ...
          <el-table-column min-width="90" align="center" prop="address" label="展具配置费"></el-table-column>
        ...
        <el-table-column min-width="90" align="center" prop="address" label="统一搬运费"></el-table-column>
        <el-table-column min-width="90" align="center" prop="address" label="包期通讯费"></el-table-column>
        <el-table-column min-width="90" align="center" prop="address" label="合计"></el-table-column>
      </el-table>
