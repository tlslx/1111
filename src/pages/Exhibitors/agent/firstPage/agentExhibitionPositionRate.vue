...
<template>
  <div class="page-container">
    <el-tabs v-model="activeName">
      <el-tab-pane label="查看展位进度" name="first">
        <el-form :inline="true" :model="queryForm">
          ...
          <el-form-item label="申请展区" size="mini" prop="exhibitionAreaCode">
            ...
            <el-select v-model="queryForm.exhibitionAreaCode" placeholder="请选择">
              <el-option v-for="item in this.exAreaOptions" :label="item.exhibitionAreaName"
        ...
        <el-table :data="exhibitionPositionPlanData.records">
          ...
          <el-table-column prop="exhibitionNum" label="界数" align="center"></el-table-column>
...
export default {
  ...
  methods: {
    ...
    getAreasFun() {
      this.getAreas({ exhibitionNum: this.queryForm.exhibitionNum, periodCode: this.queryForm.exhibitionSession }).then(res => {
        this.exAreaOptions = res;
      });
    }
  },
  filters: {
