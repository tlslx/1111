        ...
        <div class="bm bm-pj">
          <el-form :inline="true" :rules="rules" ref="ruleForm" :model="ruleForm" class="demo-ruleForm" style="width:100%" label-width="200px">
            <el-row>
              <el-col :span="12">
                <div class="bm bm-ver">
                  <el-form-item label="审核:" size="mini" placeholder="请选择" prop="firstApprove">
              ...
              <el-col :span="12">
                <div class="bm bm-ver">
                  <el-form-item require label="是否财富五百强企业或子公司:" size="mini" placeholder="请选择" prop="firstFivehundredApprove">
                    <el-select v-model="ruleForm.firstFivehundredApprove" placeholder="请选择">
                      <el-option label="是" value="1"></el-option>
                      <el-option label="否" value="0"></el-option>
                    </el-select>
                  </el-form-item>
                  <el-form-item require label="是否参加其他国际展会:" size="mini" placeholder="请选择" prop="firstOtherExhibitorApprove">
                  ...
                  <div class="bm" style="padding-left:200px">
                    <el-button type="danger" @click="checkCompany">确认</el-button>
...
export default {
  ...
  methods: {
    ...mapActions("agent", ["checkStateCompany"]),
    checkCompany() {
      this.$refs['ruleForm'].validate((valid) => {
        if (valid) {
          this.checkStateCompany(this.ruleForm).then(res => {
            // console.log(res);
            this.$router.go(-1);
          });
        }
  ...
  async created() {
    ...
    let {
      boothApplyId, companyId,
      boothNum, reason, reasonElse, firstApprove,
      firstFivehundredApprove, firstOtherExhibitorApprove
    } = JSON.parse(this.$route.query.row);

    Object.assign(this.ruleForm, {
      boothApplyId, companyId, boothNum, firstApprove,
      reason, reasonElse, firstFivehundredApprove, firstOtherExhibitorApprove
    });
