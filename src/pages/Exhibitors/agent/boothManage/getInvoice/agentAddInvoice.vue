<template>
  <el-tabs v-model="activeName">
    <el-tab-pane label="申请开具增值税发票信息" name="first">
      ...
      <el-form :rules="formRules" :model="registForm" ref="registForm" label-width="250px">
        <el-row>
          <el-form-item label="发票类型:" prop="invoiceType" size="small" >
            <el-col :span="10">
        ...
        <el-row>
          <el-form-item label="公司编号:" size="small" prop="companyNo">
            <el-col :span="10">
        ...
        <el-row>
          <el-form-item label="纳税人识别号:" size="small" prop="taxpayerId">
            <el-col :span="10">
        ...
        <el-row>
          <el-form-item label="注册地址:" size="small" prop="regAddress" >
            <el-col :span="10">
        ...
        <el-row>
          <el-form-item label="电话:" size="small" prop="telephone" >
            <el-col :span="10">
        ...
        <el-row>
          <el-form-item label="开户银行:" size="small" prop="openBank" >
            <el-col :span="10">
        ...
        <el-row>
          <el-form-item label="开户账号:" size="small" prop="openAccount" >
            <el-col :span="10">
        ...
        <el-row>
          <el-form-item label="增值税率:" size="small" prop="rate" >
            <el-col :span="10">
