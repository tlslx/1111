<template>
  <div>
    <el-form :inline="true" :model="ruleForm" class="demo-ruleForm" label-width="100px">
        <el-form-item label="届数" size="mini" prop="exhibitionNum">
          <el-select  placeholder="请选择" v-model="ruleForm.exhibitionNum">
            <el-option v-for="item in exhibitionNum" :key="item.label"
        ...
        <el-form-item label="企业名称" size="mini" prop="company_name">
          <el-input v-model="ruleForm.companyName" maxlength="80"></el-input>
        </el-form-item>
        <div class="bm bm-pe">
          <el-form-item>
