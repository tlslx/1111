...
<template>
  <el-tabs v-model="activeName">
    <el-tab-pane label="付款信息" name="first" class="payNotificate">
      ...
      <template>
        <el-table
          ...
          <el-table-column
            ...
            align="center">
            <template slot-scope="scope">
              <el-button @click="paymentEdit(scope.row, scope.$index)" type="text" size="small" :disabled="isShow">编辑</el-button>
            </template>
          </el-table-column>
          <el-table-column
            label="操作"
            ...
            fixed="right">
            <template slot-scope="scope">
              <el-button @click="pointUpload(scope.row.notificationFileId)" type="text" size="small">下载</el-button>
            </template>
          </el-table-column>
        </el-table>
        <el-button type="danger" @click="pointsUpload" style="margin-top:10px;">下载</el-button>
