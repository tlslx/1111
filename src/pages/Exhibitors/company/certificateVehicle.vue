...
<template>
  <div class="page-container">
    <el-tabs v-model="activeName">
      <el-tab-pane label="证件类型(车证)" name="first">
...
import addPapersCar from "./components/addPaperCar";
export default {
  components: {
  ...
  methods: {
    ...
    ...mapActions("certificateManage", ["getLimitTable"]),
    //获取top列表
    getTableTop(param) {
      this.getLimitTable(param).then(res => {
        // console.log(res);
