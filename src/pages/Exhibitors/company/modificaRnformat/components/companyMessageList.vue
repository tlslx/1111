    ...
    <el-collapse v-model="tables">
      ...
      <el-collapse-item  name="1">
        <template slot="title">
          <div class="submint-div">
            重要信息
            <el-button type="text" v-on:click.native.stop="submit('impInfForm')" class="submint-btn" v-if="true">保存</el-button>
        ...
        <el-form :model="impInfForm" ref="impInfForm" :rules="impInfRules">
          <el-row>
            <el-form-item label="企业英文名称:" class="inline-item" size="small" prop="companyNameEn" label-width="130px">
              <el-input v-model="impInfForm.companyNameEn" :disabled="false"></el-input>
            </el-form-item>
      ...
      <el-collapse-item  name="2">
        <template slot="title">
          <div class="submint-div">
          基本信息
          <el-button  type="text" v-on:click.native.stop="submit('baseInfForm')" class="submint-btn" v-if="true">保存</el-button>
          </div>
        </template>
        <!-- :disabled="isUpdate"  :disabled="true"-->
        <el-form :model="baseInfForm" ref="baseInfForm" :rules="baseRules" >
          <el-row>
            <el-col :span="12">
              <div class="bm bm-ver">
      ...
      <el-collapse-item  name="3">
        <template slot="title">
          <div class="submint-div">
            参展资质文件
            <el-button  type="text" v-on:click.native.stop="submit('aptitudeForm')" class="submint-btn" v-if="true">保存</el-button>
          </div>
        </template>
        <!-- :disabled="true" -->
        <el-form :model="aptitudeForm" ref="aptitudeForm" >
          <el-row>
      ...
      <el-collapse-item  name="4">
        <template slot="title">
          <div class="submint-div">
            认证获奖情况
            <el-button  type="text" v-on:click.native.stop="submit('identForm')" class="submint-btn" v-if="true">保存</el-button>
          </div>
        </template>
        <!-- :disabled="true" -->
        <el-form :model="identForm" ref="identForm" >
            <el-row>
      ...
      <el-collapse-item  name="5">
        <template slot="title">
          <div class="submint-div">
            分支机构/代理情况
            <el-button  type="text" v-on:click.native.stop="submit('exhIdenForm')" class="submint-btn" v-if="true">保存</el-button>
          </div>
        </template>
        <!-- :disabled="true" -->
        <el-form :model="exhIdenForm" ref="exhIdenForm" >
          <el-row>
      ...
      <el-collapse-item  name="6">
        <template slot="title">
          <div class="submint-div">
            出口情况
            <el-button  type="text" v-on:click.native.stop="submit('epxConForm')" class="submint-btn" v-if="true">保存</el-button>
          </div>
        </template>
        <!-- :disabled="true" -->
        <el-form :model="epxConForm" ref="epxConForm"  label-width="108px">
          <el-row>
