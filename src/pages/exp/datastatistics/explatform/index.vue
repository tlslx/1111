<template>
  <el-page ref="explatform">
    <template slot="header">
      <!--按钮栏-->
      <el-tabs v-model="activeName" @tab-click="handleClick">
        <el-tab-pane label="参展企业账号数据查询" name="first"></el-tab-pane>
        <el-tab-pane label="参展企业账号数据统计" name="second"></el-tab-pane>
      </el-tabs>
      ...
      <el-page-data>
        <kindo-box>
          <kindo-table ref="table" v-if='activeName==="first"' :cell-style="isCenter" :url="config.api.get" :queryParam="form">
            ...
            <el-table-column prop="isNewEnterprise" label="新老参展企业" :formatter="(row,column) => formatInfo(row, column)" min-width="200" show-overflow-tooltip></el-table-column>
            ...
            <el-table-column prop="accountNumSum" label="个人帐号数（个）" min-width="200" show-overflow-tooltip></el-table-column>
            <div slot="control">
  ...
  data() {
    return {
      ...
      forms: {
        ...
        enterpriseType: "",
        enterpriseAttri: "",
        reportName: "exp_report_personal_account",
        reportType: "1"
      },
      hisforms: {
        period: "",
      ...
      source: {
        statCondition: [ // 统计条件
          ...
          { id: "4", value: "histroyTag", label: "企业参展历史标签" },
          { id: "5", value: "isNewEnterprise", label: "新老参展企业" },
          { id: "6", value: "enterpriseType", label: "企业类型" },
          { id: "7", value: "enterpriseAttri", label: "企业属性" }
        ]
      }
    };
  },
