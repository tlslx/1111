<template>
  <el-page ref="expoutstatic">
    <template slot="header">
      <!--按钮栏-->
      <el-tabs v-model="activeName" @tab-click="handleClick">
        <el-tab-pane label="出口展企业参展历史标签统计" name="first"></el-tab-pane>
        <el-tab-pane label="出口展企业参展历史标签统计（以展区为单位）" name="second"></el-tab-pane>
      </el-tabs>
    ...
    return {
      ...
      source: {
        exptypes: [
          ...
          { id: "4", value: "enterpriseType", label: "企业类型" },
          { id: "5", value: "enterpriseAttri", label: "企业属性" }
        ],
        statCondition: [
          { id: "1", value: "", label: "总体" },
          { id: "2", value: "tradeTeam", label: "交易团" },
          { id: "3", value: "region", label: "地区" },
          { id: "4", value: "expRegion", label: "展区" },
          { id: "5", value: "expRegionType", label: "展位性质" },
