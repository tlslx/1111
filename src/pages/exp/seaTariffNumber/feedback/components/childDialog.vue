      ...
      onSubmit(formName) {
        ...
        this.$refs[formName].validate((valid) => {
          if (valid) {
            ...
            if (this.child.seaTariffNumberAreas) {
              params.seaTariffNumberAreas = JSON.parse(JSON.stringify(this.child.seaTariffNumberAreas));
            } else {
              params.seaTariffNumberAreas = [];
            }
            params.seaTariffNumberAreas.push({ areaCode: this.child.areaCode, areaName: kindo.dictionary.getLabel(this.source.areaCodes, this.child.areaCode), remark: this.child.remark, seaTariffId: this.rowData.id });
