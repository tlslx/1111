    ...
    <el-card class="box-card">
      <div>
        <el-tabs v-model="activeName" @tab-click="handleClick">
          <el-tab-pane label="结单" name="first">
            <el-form :model="ruleForm" ref="ruleForm" label-width="140px" class="demo-ruleForm" :rules="rules">
              ...
              <el-form-item label="回复内容：" prop="replyContent">
                {{byIdComplaint.replyContent}}
              </el-form-item>
              <el-row>
                <el-col :span="12">
                  <el-form-item label="回复者：" prop="replyUser">
                    {{byIdComplaint.replyUser}}
                  </el-form-item>
                </el-col>
                <el-col :span="12">
                  <el-form-item label="回复时间：" prop="replyTime">
                    {{byIdComplaint.replyTime}}
                  </el-form-item>
                </el-col>
              </el-row>
              ...
              <el-form-item style="text-align:center">
                <el-button class="btn1" @click="submitForm">结单</el-button>
