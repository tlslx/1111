    ...
    <!-- form表单 -->
      <el-form :inline="true" :model="formData" size="small">
        ...
        <el-form-item label="展区">
          <el-select v-model="formData.exhibitionArea" class="wInSe" placeholder="请选择">
            <el-option label="请选择" value=""></el-option>
            <el-option label="家电" value="a101"></el-option>
            <el-option label="家纺" value="a102"></el-option>
            <el-option label="工程农机（室外）" value="a103"></el-option>
          </el-select>
        </el-form-item>
        ...
        <el-form-item label="审核情况">
          <el-select v-model="formData.checkStatus" class="wInSe" placeholder="请选择">
            <el-option label="请选择" value=""></el-option>
      ...
      <el-table :data="tableData" border  v-loading.fullscreen="fullLoading" style="width: 100%">
        ...
        <el-table-column align="center" prop="region" label="城市"></el-table-column>
...
export default {
  ...
  methods: {
    ...
    handelCheck(val) {
      this.$router.push({ path: "/basic_information", query: { dataType: val }});
    },
    handelAdd() {
      this.isShow = true;
    },
