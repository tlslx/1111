  ...
  <el-tabs v-model="activeName" v-loading.fullscreen="fullLoading">
    <el-tab-pane label="交易团登记企业母子关系审核结果" name="first">
      ...
      <el-table :data="tableData" style="width: 100%" @selection-change="handleSelectionChange">
        ...
        <el-table-column align="center" prop="companyName" label="申请企业名称"></el-table-column>
        <el-table-column align="center" prop="aptitudeType" label="资质类型">
        ...
        <el-table-column align="center" prop="correlationCompanyName" label="资质对应企业名称"></el-table-column>
        <el-table-column align="center" prop="exhibitionArea" label="资质使用展区"></el-table-column>
        <el-table-column align="center" prop="checkResult" label="交易团审核情况">
          <template slot-scope="scope">{{scope.row.checkResult | checkresu}}</template>
        </el-table-column>
        <el-table-column align="center" prop="materialCode" label="材料编号"></el-table-column>
    ...
    handelServe() {
      if (this.formDat.registerId) {
        ...
        for (let i = 0; i < this.options.length; i++) {
          if (this.options[i].value === this.formDat.exhibitionCode) {
            this.formDat["exhibitionArea"] = this.options[i].label;
          }
        }
        if (this.formDat.cantonFairCode === "") {
          this.$message("广交会编码不能为空");
