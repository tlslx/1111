  ...
  <div>
    ...
    <el-form :inline="true" :model="formInline" class="demo-form-inline" size="small" >
      <el-form-item label="商协会">
        ...
        <el-select v-model="formInline.coceralId" size="small" class="wid" clearable>
          <el-option
      ...
      <el-form-item label="交易团">
        ...
        <el-select v-model="formInline.dealClusterId" size="small" class="wid" clearable>
          <el-option
      ...
      <el-form-item label="展区">
        ...
        <el-select v-model="formInline.exhibitionArea" size="small" class="wid" clearable>
          <el-option
      ...
      <el-form-item label="评审企业">
        <el-input v-model.trim="formInline.companyName" size="small" class="wid"></el-input>
      </el-form-item>
      <el-form-item>
    ...
    <el-button style="margin-top: 20px;" type="primary" @click="handDownload">下载</el-button>
  ...
  methods: {
    ...
    onSubmit() {
      ...
      let objOne = {
        ...
        coceralId: this.formInline.coceralId,
        dealClusterId: this.formInline.dealClusterId,
        exhibitionArea: this.formInline.exhibitionArea,
        current: 1,
        size: 10
      };
    ...
    // 下载
    handDownload() {
      let url = "companyName=" + this.formInline.companyName + "&coceralId=" + this.formInline.coceralId + "&dealClusterId=" + this.formInline.dealClusterId + "&exhibitionArea=" + this.formInline.exhibitionArea;
      url = url.replace(/undefined/g, "");
      window.open(process.env.API_NA_URL + "/api/schemePublicityLog/download?" + url + "&token=" + localStorage.getItem("USER_TOKEN"), "_parent");
    },
    handleSizeChange() {},
    // 分页
