    ...
    <el-tab-pane label="商协会提交品牌展位数量安排方案" name="first">
      ...
      <el-table :data="tableList" style="width: 100%" border>
        <el-table-column align="center" label="企业基本信息">
          ...
          <el-table-column align="center" label="海关编码" prop="customsCode" width="100"></el-table-column>
        ...
        <el-table-column align="center" label="评审项目得分">
          ...
          <el-table-column align="center" label="高新技术企业或高新技术产品" prop="newHighSocre" width="120"></el-table-column>
          ...
          <el-table-column align="center" label="境外商标" prop="beyondSocre" width="120"></el-table-column>
        </el-table-column>
...
export default {
  ...
  methods: {
    ...
    handleCurrentChange(current) {
      let objWne = {
        coceralName: this.formData.coceralName,
