    ...
    <el-tab-pane label="交易团反馈品牌数量安排方案公示意见" name="first">
      ...
      <el-form :model="formData" size="small" :inline="true">
        <el-form-item label="商协会">
          <el-select v-model="formData.coceralName">
            <el-option label="请选择" value></el-option>
            <el-option label="商会1" value="商会1"></el-option>
            <el-option label="商会2" value="商会2"></el-option>
          </el-select>
        </el-form-item>
        <el-form-item label="展区">
          <el-select v-model="formData.exhibitionAreaName">
            <el-option label="请选择" value></el-option>
            <el-option label="家电" value="家电"></el-option>
            <el-option label="家纺" value="家纺"></el-option>
          </el-select>
        </el-form-item>
        ...
        <el-form-item label="交易团">
          <el-select v-model="formData.dealClusterName">
            <el-option label="请选择" value></el-option>
            <el-option label="交易团1" value="交易团1"></el-option>
          </el-select>
        </el-form-item>
        ...
        <template v-for="(item, index) in tableDataMin">
          <el-table-column :key="index" align="center" :label="item.label" :prop="item.prop" v-if="item.aFirst">
            <template slot-scope="scope">
              <span>{{scope.row.status === "1" ? "已提交外贸司" : "未提交外贸司"}}</span>
            </template>
          </el-table-column>
