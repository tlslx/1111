...
<template>
  <el-tabs v-model="activeName">
    <el-tab-pane label="交易团审核联营企业列表" name="first">
      <div class="sort-btns">
        联营企业名称：
        <el-input
...
export default {
  ...
  methods: {
    ...mapActions("JointVentureManagement", [
      "getAssociateEnterprisesInfo",
      "approveAssociateEnterprisesInfo"
    ]),
    // 获取搜索输入的值
    getSearch(val) {
    ...
    getSearchData() {
      if (
        (this.searchContent !== "" && this.approveStatus !== "") || (this.searchContent === "" && this.approveStatus !== "")
      ) {
      ...
      } else if (this.searchContent !== "" && this.approveStatus === "") {
        this.searchParams.customQueryParams = [
          {
            name: "nameCh",
            findType: "LIKE",
