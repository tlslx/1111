      ...
      >
        ...
        <el-table-column align="center" label="操作" width="200">
          <template slot-scope="scope">
            ...
            <!-- <el-button :disabled="scope.row.workDepartmentStatus === '1'" @click="handleNotgo(scope.row)" type="text" size="small">不通过</el-button> -->
          </template>
        </el-table-column>
      </el-table>
      <el-button type="primary" @click="handlePass" size="small">通过</el-button>
  ...
  data() {
    return {
      ...
      searchParams: {
        ...
        businessAssociationStatus: "1",
        workDepartmentStatus: "0",
        size: "10",
        current: "1"
      },
      ...
      this.getReviewAreaAdjustment(values)
        .then(res => {
          ...
          for (let i = 0; i < skb.length; i++) {
            if (skb[i].workDepartmentStatus === "0") {
              arrList.push(skb[i]);
            }
          }
      ...
      if (rows) {
        rows.forEach(row => {
          ...
          if (row) {
            ...
            searchParamPass.workDepartmentStatus = "1";
