      ...
      >
        ...
        <el-table-column align="center" label="操作" width="200">
          <template slot-scope="scope">
            ...
            <!-- <el-button :disabled="scope.row.foreignTradeStatus === '1'" @click="handleNotgo(scope.row)" type="text" size="small">不通过</el-button> -->
          </template>
        </el-table-column>
      </el-table>
  ...
  data() {
    return {
      ...
      searchParams: {
        ...
        workDepartmentStatus: "1",
        foreignTradeStatus: "0",
        size: "10",
        current: "1"
      },
      ...
      if (rows) {
        rows.forEach(row => {
          ...
          if (row) {
            ...
            searchParamPass.foreignTradeStatus = "1";
    ...
    handlePass(val) {
      ...
      this.$confirm('请确认执行该操作', '提示', {
        ...
        if (this.getList && val === "pass") {
          ...
          this.getList.foreignTradeStatus = 2;
          this.postReviewAreaAdjustmentBatch(this.getList).then(() => {
            this.handleClickData(this.searchParams);
            this.$message({
              type: 'success',
