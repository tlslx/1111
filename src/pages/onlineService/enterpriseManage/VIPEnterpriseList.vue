...
<template>
  <el-page ref="VIPEnterpriseList">
    <template slot="body">
      <el-tabs v-model="activeName" @tab-click="handleClick">
        <el-tab-pane label="首批VIP企业名单" name="0">
          <search-param-link :searchParamsForm="searchParamsForm.data"
            :variate="searchParamsForm.variate"
            :dictionary="dictionaryData"
            @select-params="selectParams">
          </search-param-link>
          <cust-table class="vip-enterprise-list" :cols="cols" :data="companyData" :loading="loading"></cust-table>
