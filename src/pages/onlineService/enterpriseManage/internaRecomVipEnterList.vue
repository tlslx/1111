...
<style scoped>
  ...
  .interna-edit-table >>> .el-form-item {
    margin-bottom: 0;
  }
</style>
<template>
  <el-tabs v-model="activeName" @tab-click="handleClick">
    <el-tab-pane label="交易团推荐VIP企业名单" name="0">
      ...
      <div class="interna-recom-btn-container">
        <div class="btn-bar">
