...
<template>
  <el-tabs v-model="activeName">
    <el-tab-pane label="组展表彰结果公布管理" name="first">
        ...
        <el-table
          ...
          <el-table-column fixed="right"
            ...
            <template slot-scope="scope">
              <el-button @click="handleClick(scope.row)" type="text" size="small">查看下载明细下载</el-button>
            </template>
          </el-table-column>
        </el-table>
      ...
      <div class="submit_back">
        ...
        <el-button type="danger" class="submit_btn" @click="downLoadList">下载</el-button>
      </div>
    </el-tab-pane>
  </el-tabs>
</template>
