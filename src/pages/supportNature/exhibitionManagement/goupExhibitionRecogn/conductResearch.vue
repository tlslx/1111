...
<template>
  <el-tabs v-model="activeName">
    <el-tab-pane label="工作总结提交及配合调研情况" name="first">
      <el-form :inline="true" :model="ruleForm" class="demo-ruleForm">
        ...
        <el-form-item label="积极配合大会业务办开展各类调研:" size="mini" label-width="270px">
          <el-input v-model="ruleForm.surveyValue" disabled></el-input>
        </el-form-item>

        <el-form-item label="是否按时、高质量报送本团当届工作总结:" size="mini" label-width="270px">
          <el-input v-model="ruleForm.workValue" disabled></el-input>
        </el-form-item>
      ...
      <template>
        <el-table
          ...
          <el-table-column
            prop="isSurveyPositive"
            label="是否积极配合大会业务办开展各类调研"
            align="center">
            <template slot-scope="scope">
              <span v-if="scope.row.isSurveyPositive==0">否</span>
              <span v-else-if="scope.row.isSurveyPositive==1">是</span>
            </template>
          </el-table-column>
          <el-table-column
            prop="isWorkSummaryPassed"
            label="是否按时、高质量报送本团当届工作总结"
            align="center">
            <template slot-scope="scope">
              <span v-if="scope.row.isWorkSummaryPassed==0">否</span>
              <span v-else-if="scope.row.isWorkSummaryPassed==1">是</span>
            </template>
          </el-table-column>
          <el-table-column
            prop="isPassed"
            label="组展表彰指标-配合调研达标情况"
            align="center">
            <template slot-scope="scope">
