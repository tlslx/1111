...
<template>
  <el-tabs v-model="activeName">
    <el-tab-pane label="交易团特定展位需求申报列表" name="first">
      ...
      <template>
        <el-table
          ...
          <el-table-column fixed="right"
            ...
            width="130">
            <template slot-scope="scope">
              <el-button @click="handleDeclare(scope.$index, scope.row)" type="text" size="small">申报</el-button>
...
export default {
  ...
  mounted() {
    // 列表展示
    this.getDelegationPage(this.boothParams).then(res => {
  ...
  methods: {
    ...
    ...mapActions("enterpriseBooth", ["getDelegationPage"]), // 列表展示
