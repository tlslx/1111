...
<template>
    <div class="addBooth">
      <el-tabs v-model="activeName">
        <el-tab-pane label="申报展位（不限制数量）" name="first">
...
export default {
  ...
  methods: {
    ...
    onSubmit(addForm) {
      ...
      this.checkParams.customQueryParams[2].values.push(this.addForm.ifoBoothApply.exhibitionAreaCode);
