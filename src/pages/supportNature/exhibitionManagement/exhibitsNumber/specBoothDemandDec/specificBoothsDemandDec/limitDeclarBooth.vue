...
<template>
    <div class="addBooth">
      <el-tabs v-model="activeName">
        <el-tab-pane label="申报展位（限制数量）" name="first">
...
export default {
  ...
  mounted() {
    ...
    if (this.$route.query.data) {
      console.log(999, this.$route.query.data);
  ...
  methods: {
    // 返回
    backSearchSchemes() {
      this.$router.replace('/specificBoothsList');
    }
  }
};
</script>
