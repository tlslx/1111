    ...
    <el-tab-pane label="查询统计" name="first">
      <el-form :inline="true" :model="boothParams" class="demo-ruleForm">
        ...
        <el-form-item label="交易团:" size="mini" v-show="isShow">
          ...
          <el-select v-model="boothParams.delegationId" placeholder="请选择">
            <el-option label="全部" value=""></el-option>
            <el-option v-for="item in ruleForm.deptArr" :label="item.deptName" :value="item.deptId" :key="item.deptId"></el-option>
          </el-select>
        </el-form-item>
      ...
      <template>
        <el-table
          ...
          <el-table-column
            prop="applyNumOfOneSession"
            label="一期总数"
            align="center">
          </el-table-column>
          <el-table-column
            prop="applyNumOfTwoSession"
            label="二期总数"
            align="center">
          </el-table-column>
          <el-table-column
            prop="applyNumOfThreeSession"
            label="三期总数"
            align="center">
          </el-table-column>
          <el-table-column
...
export default {
  name: "queryStatisTradeGroupDimensions",
  data() {
    return {
      activeName: 'first',
      tableData: [],
  ...
  mounted() {
    // 列表展示
    this.getStaticsOfDelegation(this.boothParams).then(res => {
  ...
  methods: {
    ...
    ...mapActions("enterpriseBooth", ["getStaticsOfDelegation"]), // 列表展示
