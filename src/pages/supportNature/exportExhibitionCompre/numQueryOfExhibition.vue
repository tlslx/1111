...
<template>
  <el-tabs v-model="activeName">
    <el-tab-pane label="各团各展区展位数量查询" name="first">
      <el-form :inline="true" :model="ruleForm" class="demo-ruleForm">
        ...
        <el-form-item label="商会:" size="mini" v-show="isShow">
          <!-- 交易团下拉框 -->
          <el-select v-model="delegationId" placeholder="请选择">
            <el-option label="全部" value=""></el-option>
          </el-select>
        ...
        <el-form-item label="类别:" size="mini" v-show="isShow">
          <el-select v-model="delegationId" placeholder="请选择">
            <el-option label="全部" value=""></el-option>
          </el-select>
        </el-form-item>
