...
<template>
  <el-tabs v-model="activeName">
    <el-tab-pane label="企业资料下载" name="first">
      <el-form :inline="true" :model="ruleForm" class="demo-ruleForm">
        <el-form-item label="交易团:" size="mini">
          <el-select v-model="businessDelegationId" placeholder="请选择">
        ...
        <el-form-item>
          ...
          <el-checkbox label="联系电话" name="type"></el-checkbox>
          <el-checkbox label="企业英文地址" name="type"></el-checkbox>
          <el-checkbox label="美食/企业中文地址" name="type"></el-checkbox>
        </el-form-item><br>

        <el-form-item label="文件格式:" size="mini">
          <el-radio v-model="radio" label="XLS"></el-radio>
          <el-radio v-model="radio" label="TXT"></el-radio>
        </el-form-item>

        <el-checkbox label="传真" name="type"></el-checkbox>
        <el-checkbox label="联系人" name="type"></el-checkbox>
        <el-checkbox label="企业代码，海关编码" name="type"></el-checkbox>
      </el-form>
