...
<template>
  <el-tabs v-model="activeName">
    <el-tab-pane label="品牌申请情况汇总" name="first">
      <el-form :inline="true" :model="ruleForm" class="demo-ruleForm">
        ...
        <el-form-item v-show="isShow">
          ...
          <el-radio v-model="radio" label="2" @change="applicationReduce">申请减少</el-radio>
        </el-form-item><br>

        <el-form-item label="广交会编码:" size="mini" v-show="isShow">
          <!-- 广交会编码下拉框 -->
