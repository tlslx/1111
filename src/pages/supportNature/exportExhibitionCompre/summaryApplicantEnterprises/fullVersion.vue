...
<template>
  <el-tabs v-model="activeName">
    <el-tab-pane label="各展区申请企业汇总" name="first">
      <el-form :inline="true" :model="ruleForm" label-width="120px" class="demo-ruleForm">
        ...
        <el-form-item label="审核情况:" size="mini">
          <el-select v-model="ruleForm.periodCode" placeholder="请选择">
            <el-option label="全部" value=""></el-option>
            <el-option label="一期" value="一期"></el-option>
            <el-option label="二期" value="二期"></el-option>
        ...
        <el-form-item label="展示产品:" size="mini">
          <el-input v-model="ruleForm.periodCode"></el-input>
        </el-form-item>
        ...
        <el-form-item label="HS编码是否匹配:" size="mini">
          <el-select v-model="ruleForm.periodCode" placeholder="请选择">
            <el-option label="全部" value=""></el-option>
            <el-option label="一期" value="一期"></el-option>
            <el-option label="二期" value="二期"></el-option>
      ...
      <div class="tableTip">
        <p class="appliExhibition">共查询到12条记录</p>
