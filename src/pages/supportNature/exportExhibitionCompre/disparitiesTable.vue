...
<template>
  <el-tabs v-model="activeName">
    <el-tab-pane label="展位数量安排差异情况表" name="first">
      <el-form :inline="true" :model="ruleForm" class="demo-ruleForm">
        ...
        <el-form-item label="展馆:" size="mini">
      ...
      <template>
        <el-table
          ...
          <el-table-column
            prop="companyApplyOfOkNumber"
            label="本届交易团企业展位安排"
            align="center">
          </el-table-column>
          <el-table-column
            prop="exhibitionApplyNumber"
            label="出现安排数量差异的环节"
            align="center">
          </el-table-column>
          <el-table-column
            prop="exhibitionApplyArea"
            label="数量差异"
            align="center">
          </el-table-column>
          <el-table-column
