...
<template>
  <el-tabs v-model="activeName">
    <el-tab-pane label="各交易团初审情况统计" name="first">
      ...
      <template>
        <el-table
          ...
          <el-table-column
            prop="companyApplyNumber"
            label="申报企业数"
            align="center">
          </el-table-column>
          <el-table-column
            prop="companyNumberOfOK"
            label="初审合格企业数量"
            align="center">
          </el-table-column>
          <el-table-column
            prop="companyNumberOfNO"
            label="初审不合格企业数量"
            align="center">
          </el-table-column>
          <el-table-column
            prop="companyNumberOfPending"
            label="初审待定企业数量"
            align="center">
          </el-table-column>
          <el-table-column
            prop="companyNumberOfNOApply"
            label="初审不合格再提交企业数量"
            align="center">
          </el-table-column>
          <el-table-column
            prop="companyNumberOfNone"
            label="未初审企业数量"
            align="center">
          </el-table-column>
        </el-table>
...
export default {
  name: "firstInspectTradingGroups",
  data() {
    return {
      activeName: 'first',
      tableData: [],
  ...
  mounted() {
    // 列表展示
    this.delegationApply(this.boothParams).then(res => {
  ...
  methods: {
    ...mapActions("enterpriseBooth", ["delegationApply"]), // 列表展示
   ...
   */
    ...
    downLoad() {
      ...
      kindo.util.getdown(`${process.env.API_NA_URL}/api/speciaAreaExternal/delegationApply/download?${this.encodeSearchParams(downLoadParams)}`, '各交易团初审情况统计.xls');
    }
  }
};
</script>
