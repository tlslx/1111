...
<template>
  <el-tabs v-model="activeName">
    <el-tab-pane label="按就餐地点和日期统计" name="first">
      <el-form :inline="true" :model="ruleForm" class="demo-ruleForm">
        <el-form-item label="就餐地点:" size="mini">
          <el-select v-model="ruleForm.applyYear" placeholder="请选择">
            ...
            <el-option label="广交会餐厅" value="0"></el-option>
            <el-option label="员工餐厅(东厅)" value="1"></el-option>
            <el-option label="员工餐厅(西厅)" value="2"></el-option>
          </el-select>
        </el-form-item>

        <el-form-item label="就餐日期:" size="mini">
          <el-date-picker v-model="timeDate" align="right" type="date" placeholder="选择日期" :picker-options="pickerOptions"></el-date-picker>
        </el-form-item>
