...
<template>
  <el-tabs v-model="activeName">
    <el-tab-pane label="就餐人员名单" name="first">
      <el-form :inline="true" :model="boothParams" class="demo-ruleForm">
        ...
        <el-form-item label="所在单位" size="mini">
          <el-input v-model="boothParams.applicationUnitAdministrativePosition" placeholder="请输入" clearable></el-input>
        </el-form-item>
