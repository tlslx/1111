...
<template>
  <el-tabs v-model="activeName">
    <el-tab-pane label="就餐记录" name="first">
      <el-form :inline="true" :model="boothParams" class="diningRuleForm">
        <el-form-item label="就餐日期" size="mini">
          <el-date-picker v-model="boothParams.mealTime" align="right" type="date" placeholder="选择日期" :picker-options="pickerOptions"></el-date-picker>
        </el-form-item>

        <el-form-item label="就餐地点:" size="mini">
          <el-select v-model="boothParams.diningPlace" placeholder="请选择">
            <el-option label="全部" value=""></el-option>
            <el-option label="广交会餐厅" value="1"></el-option>
            <el-option label="员工餐厅(东厅)" value="2"></el-option>
            <el-option label="员工餐厅(西厅)" value="3"></el-option>
          </el-select>
        </el-form-item>

        <el-form-item label="单位" size="mini">
          <el-input v-model="boothParams.applicationOrgName" placeholder="请输入" clearable></el-input>
        </el-form-item>

        <el-form-item label="姓名" size="mini">
          <el-input v-model="boothParams.applicationName" placeholder="请输入" clearable></el-input>
        </el-form-item>

        <el-form-item label="展期:" size="mini">
          <el-select v-model="boothParams.numberParticipants" placeholder="请选择">
            <el-option label="全部" value=""></el-option>
