...
<template>
  <el-tabs v-model="activeName">
    <el-tab-pane label="大会领导委员会委员任职名单撤回列表" name="first">
      <div class="above-table">大会领导委员会委员任职名单撤回列表
        <el-button type="text" class="download">下载XLS</el-button>
    ...
    <el-tab-pane label="报送人员信息撤回列表" name="second">
      <div class="above-table">报送人员信息撤回列表
        <el-button type="text" class="download">下载XLS</el-button>
        <el-button type="text" class="print">打印</el-button>
      </div>
      <el-table border>
    ...
    <el-tab-pane label="驻地信息撤回列表" name="third">
      <div class="above-table">驻地信息撤回列表
        <el-button type="text" class="download">下载XLS</el-button>
        <el-button type="text" class="print">打印</el-button>
      </div>
      <el-table border>
    ...
    <el-tab-pane label="商会、协会秘书长以上参会人员信息撤回列表" name="fourth">
      <div class="above-table">商会、协会秘书长以上参会人员信息撤回列表
        <el-button type="text" class="download">下载XLS</el-button>
        <el-button type="text" class="print">打印</el-button>
      </div>
      <el-table border>
