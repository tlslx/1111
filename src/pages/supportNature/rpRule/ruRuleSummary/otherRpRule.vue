      ...
      <template>
        <el-table border :header-cell-style="tableHeaderColor" :data="tableData" v-loading="loading" height="490" style="width: 100%" id="out-table">
          ...
          <el-table-column label="操作" align="center" width="260">
            <template slot-scope="scope">
              <el-button type="danger" plain size="medium" v-if="scope.row.status==='审核不通过'" @click="currentRowModify(scope.row)">修改</el-button>
...
export default {
  ...
  methods: {
    ...
    exportExcel() {
      ...
      this.getDownloadListjf(this.downloadParams); // 奖罚信息审核
    },
    //修改
