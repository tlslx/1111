        ...
        <el-col :span="24">
          ...
          <div class="formBox" v-show="isPass === 2">
            ...
            <div v-show="resit === true">
              <el-form-item prop="newPwd" style="margin-bottom:40px;" >
                <el-input v-model="formVal.newPwd" type="password" autocomplete="off" placeholder="设置密码"></el-input>
              </el-form-item>
              <el-form-item prop="confirmPwd" style="margin-bottom:25px;">
                <el-input v-model="formVal.confirmPwd" type="password" autocomplete="off" placeholder="确认密码"></el-input>
              </el-form-item>
          </div>
          ...
          <div class="yzm-btn" >
              ...
              <el-form-item style="text-align: left;" label-width="100px">
                <el-button style="width: 100%;margin-top: 40px;" type="primary" @click="handleConfirm('formVal')">确认</el-button>
              </el-form-item>
            </el-form>
          </div>
          ...
          <div class="formBox" v-show="isPass === 4">
            <div class="success"><span class="sucMsg">您已经成功设置密码，请试用新密码登陆 </span>
              <el-button style="width: 100%;height:40px;margin:40px 0;" type="danger" @click="toLogin">马上登陆</el-button>
            </div>
          </div>
        </el-col>
      </el-row>
...
export default {
  ...
  computed: {
    ...
    ...mapGetters("findPwdInfo", ["testCheckVerifyCodeImg"]),  //验证手机验证码
