  ...
  <el-form :ref="name" :model="form" :sub-data="subData" 
    ...
    <el-tabs v-model="activeTab">
      <el-tab-pane label="基本信息" name="baseInfo">
        <el-row>
          <el-form-col label="角色名称：" prop="roleName" :span="24" required>
            <el-input v-model="form.roleName" :disabled="isView" minlength= "1" maxlength= "20"></el-input>
          </el-form-col>
          ...
          <el-form-col label="备注：" prop="remark" :span="24">
            <el-input type="textarea" v-model="form.remark" :disabled="isView" minlength= "1" maxlength= "100"></el-input>
          </el-form-col>
        </el-row>
      </el-tab-pane>
      ...
      <el-tab-pane label="角色用户信息" name="roleUsers">
        ...
        <el-datagrid ref="detailtable" :height="300" 
          ...
          <el-table-column prop="positionType" label="职位类型" width="200">
          </el-table-column>
          <el-table-column prop="job" label="职别" width="200">
          </el-table-column>
        </el-datagrid>
      </el-tab-pane>
    </el-tabs>
    ...
    pageLoad() {
      if (this.isLoadedMenuTree === false) {
        this.$http.get("/api/sysMenu/getListAll").then(data => {
          ...
          try {
            this.form.authList = this.getChildren(this.form.authList, this.menuData);
