          ...
          <div class="login-form">
            <el-form ref="form" :model="view.model" :rules="view.rules" @submit.native.prevent @keyup.enter.native="signIn" size="large" v-if="kindo.config.loginTheme !== 'loginBlue'">
              ...
              <el-form-item style="text-align:left;">
                ...
                <!-- <span class="findPwd-btn" @click="findPwd" round>忘记密码?</span> class="regist_btnT"  v-if="kindo.config.theme !== 'blue'"  v-else-->
              </el-form-item>
...
.theme-blue .login-form .sign-input {
  margin-bottom: 18px;
}
.theme-blue .el-form-item {
  margin-bottom: 10px;
}
.theme-red .login-form .sign-input {
  margin-bottom: 18px;
}
.theme-red .el-form-item {
  margin-bottom: 10px;
}
</style>
